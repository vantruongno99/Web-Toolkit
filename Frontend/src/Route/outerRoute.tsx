...
const Vendor = React.lazy(() => import("../View/Vendors"));
const VendorCreate = React.lazy(() => import("../View/VendorCreate"));
const VendorList = React.lazy(() => import("../View/VendorList"));
const VendorById = React.lazy(() => import("../View/Vendor"));
const Application = React.lazy(() => import("../View/Application"));
const Approval = React.lazy(() => import("../View/Approval"));
